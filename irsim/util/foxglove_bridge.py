...
# /irsim/scene (foxglove.SceneUpdate) is temporarily disabled.
# To re-enable: add the schema entry back to _SCHEMAS and uncomment
# the matching line in _SCHEMA_NAMES.
